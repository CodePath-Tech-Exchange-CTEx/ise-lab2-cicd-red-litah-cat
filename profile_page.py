...
def display_profile_page(user_id):
    ...
    st.markdown("Fill out your profile so your AI trainer can personalise advice for you.")
    ...
    with st.form("fitness_profile_form"):
        ...
        level_index = fitness_level_options.index(saved_level) if saved_level in fitness_level_options else 0
        fitness_level = st.selectbox("Fitness Level", fitness_level_options, index=level_index)
        ...
        submitted = st.form_submit_button("Save Profile", use_container_width=False)
    ...
    if submitted:
        if not first_name or not last_name:
            ...
            try:
                ...
                st.success("Profile saved! Your AI trainer will now use this to personalise your advice.")
                st.rerun()
